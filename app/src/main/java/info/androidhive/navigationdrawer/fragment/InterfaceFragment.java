...
import info.androidhive.navigationdrawer.adapters.InterfaceListViewAdapter;
...
public class InterfaceFragment extends android.support.v4.app.Fragment implements InterfaceListViewAdapter.UpdateList {

    public static final String MY_PREFS_NAME = "eagle_eye_prefs";
    private RecyclerView recyclerView;
    private InterfaceListViewAdapter interfaceListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_interfacelist, container, false);
    ...
    private void requestData() {
        try {
            ...
            rtmRequestMessage.setMsgCode(2000);
    ...
    public void onEventMainThread(InterfaceEvent event) {
        //  view.setText(view.getText() + "\n" + event.getData());
        Log.i("EVENT", "event captured in Interface fragment :: " + event.getData());
        //   mCursor = db.getAllInterfaces();
        interfaceListAdapter = new InterfaceListViewAdapter(getContext(), userName, event.getData());
        interfaceListAdapter.updateList = this;
        recyclerView.setAdapter(interfaceListAdapter);
        interfaceListAdapter.notifyDataSetChanged();
